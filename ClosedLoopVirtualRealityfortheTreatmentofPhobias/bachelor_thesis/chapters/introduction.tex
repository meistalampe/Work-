...
The heart consists of a three forms of cardiac muscle tissue, atrial, ventricular and specialized conducting fibers. The atrial and ventricular muscle fibers primarily serve the pumping function of the heart and form a syncytium, which permits rapid spread of depolarization across the heart. Whereas the conducting fibers serve as an electrical conducting system connecting the atrial and the ventricular syncytium. The atrial and the ventricular portions of the heart each function as a single pumping unit. It is crucial that the action of each chamber is coordinated in a fashion where the ventricular contraction follows shortly after the atrial contraction. 
