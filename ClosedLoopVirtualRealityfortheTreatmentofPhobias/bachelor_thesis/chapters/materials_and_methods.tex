...
We used the Unity network engine to create a server script that reads incoming data streams, sent to the VRU's IP-address and the specific port 8632. The received data was read into a string format


- variables in the array , tabelle vllt--- array slot, variable name, variable type, possible values
